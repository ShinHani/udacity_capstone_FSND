...
def create_app(test_config=None):
    ...
    def add_movie(payload):
        ...
        if not new_title or not new_genre or not new_producer or not new_release_date:
            abort(400)
        try:
            new_movie = Movie(title=new_title, genre=new_genre, producer=new_producer, release_date=new_release_date)
            new_movie.insert()
